const LIGHT_ROUTE_HEADER_COLORS = {
  ...
  EnderecosScreen: '#374151',
  ProfileScreen: '#f7f7f8',
  NotificationSettings: '#6cb6a5',
  SqlScreen: '#2563EB',
  TratarScreen: '#c2410c',
  ConferenciaTratativasRecebimentoScreen: '#c2410c',
  EspelhoRecebimentoScreen: '#c2410c',
  ConferenciaRecebimentoScreen: '#0f766e',
  ConferenciaSaidaScreen: '#4338ca',
  ConferenciaDivergenciasScreen: '#06b6d4',
  ExcelScreen: '#012677',
  PdfScreen: '#d7263d',
...
const DARK_ROUTE_HEADER_COLORS = {
  ...
  EnderecosScreen: '#1F2937',
  ProfileScreen: '#2f333a',
  NotificationSettings: '#1a4645',
  SqlScreen: '#1E40AF',
  TratarScreen: '#c2410c',
  ConferenciaTratativasRecebimentoScreen: '#9a3412',
  EspelhoRecebimentoScreen: '#9a3412',
  ConferenciaRecebimentoScreen: '#0f766e',
  ConferenciaSaidaScreen: '#4338ca',
  ConferenciaDivergenciasScreen: '#0891b2',
  ExcelScreen: '#012677',
  PdfScreen: '#d7263d',
  PdfViewerScreen: '#294380',
  BarcodeScannerScreen: '#000000',
