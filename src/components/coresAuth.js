...
export const CORESPRODUCTITEM = {
  ...
  imageBorder: '#e0e0e0',
  placeholderDark: '#3a4265',
  placeholderBorderDark: '#1f2438',
  modalBackground: 'rgba(0, 0, 0, 0.95)',
  modalCloseBackground: 'rgba(0, 0, 0, 0.5)',
  infoModalBackdrop: 'rgba(5, 6, 9, 0.68)',
  infoModalSurface: '#35332f',
  infoModalBorder: 'rgba(255,255,255,0.06)',
  infoModalInnerSurface: '#2b2925',
  infoModalInnerBorder: 'rgba(255,255,255,0.04)',
  infoModalTitle: '#f7f4ee',
  infoModalSubtitle: 'rgba(247,244,238,0.78)',
  infoModalLabel: 'rgba(247,244,238,0.76)',
  infoModalValue: '#ffffff',
  infoModalDivider: 'rgba(255,255,255,0.08)',
  infoModalCloseSurface: 'rgba(255,255,255,0.03)',
  infoModalCloseBorder: 'rgba(255,255,255,0.16)',
  infoModalIconSurface: 'rgba(255,255,255,0.06)',
  white: '#ffffff',
  shadow: '#000000',
  badgeExpired: '#6b7280',
  badgeToday: '#dc2626',
...
export const CORESBARCODESCANNER = {
  ...
  controlBg: 'rgba(15, 18, 28, 0.62)',
  controlActive: '#ea580c',
